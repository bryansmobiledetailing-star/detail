...
function durationToRecord(durationStr, isSpecialty) {
  ...
  return `'${durationStr}'`; // Fallback for things like ADD_ONS
}

// Just match all objects in export const SERVICES = [ ... ];
// A bit hacky but it works locally
