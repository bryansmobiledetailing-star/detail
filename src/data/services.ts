...
export const SERVICES: Service[] = [
  ...
  },
  {
    ...
    longDescription: 'The absolute pinnacle of automotive surface care. As System X certified installers, we meticulously prepare your vehicle by completely decontaminating the exterior and performing a precision Paint Correction to guarantee the paint is completely flawless. Immediately after, we seal that perfection under a premium, chemically bonded Ceramic Coating. This package guarantees years of extreme durability against UV rays and chemical staining, stunning visual depth, and effortless maintenance.',
